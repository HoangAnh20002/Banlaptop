    ...
    <div>
            ...
            <div className=' m-12 grid grid-cols-4 gap-8'>
                ...
                <div className='grid grid-cols-4 max-[767px]:grid-cols-1 gap-20 mt-5 pb-4  border-2 shadow-2xl border-gray-400'>
                        <div className='col-span-1 w-fit h-fit'><img src="https://laptop2.webdaitin.net/wp-content/uploads/2020/08/photo1536787648594-15367876485951618993598-300x188.jpg"></img></div>
                        <div className='col-span-3 my-auto'>
                            <Link to='#'><div className='text-start font-bold hover:text-rose-500'>Giá iPhone XS và iPhone XR tại VN được tiết lộ: Thấp nhất 22 triệu, cao nhất 43 triệu, bán cuối tháng 10 </div> </Link>
                            <div className='text-start'>Với iPhone XS Max, một kỷ lục mới về giá đã được thiết lập. Ngay sau khi bộ ba iPhone XS, iPhone XS Max và iPhone XR được Apple công bố, FPT Shop - một trong những đơn vị bán ...</div>
                        </div>
                    </div>
