...
function LaptopHp() {
  return (
    <div>
        <Header />
        <div className='mt-4 mx-20 grid grid-cols-7 max-[1200px]:grid-cols-4 max-[767px]:grid-cols-3 max-[639px]:grid-cols-2'>
                    <div className='w-40 h-10 p-2 text-white bg-[#4eac4b] col-span-1'>
                        Laptop Hp
                    </div>
                    <div className='h-10 w-f bg-gray-200 border-b-2 border-b-[#4eac4b] col-span-6 flex justify-end'>
                        <a>
                            <div className='m-2'>
                                Laptop
                            </div></a>
                        <a href='#'><div className='m-2'>
                            Laptop Hp
                        </div>
                        </a>
                    </div>
                ...
                <div className='mt-4 mx-20 grid grid-cols-5 max-[1200px]:grid-cols-4 max-[767px]:grid-cols-3 max-[639px]:grid-cols-2 gap-8'>
                    <div className='bg-gray-100 h-auto w-auto p-2 shadow-xl'>
                        <div>
                            <img src='https://laptop2.webdaitin.net/wp-content/uploads/2020/08/HP-Omen-15-Gaming-Laptop-1-510x510-1.jpg'></img>
                        </div>
